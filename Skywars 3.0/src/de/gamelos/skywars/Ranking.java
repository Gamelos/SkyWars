...
public class Ranking {
	...
	public static void updateranking(){
		...
		ss.setLine(0, "===========");
		ss.setLine(1, "Top 10");
		ss.setLine(2, "in Skywars");
		ss.setLine(3, "===========");
		ss.update();
		
//		===================================================================================================================
		if(de.gamelos.stats.SQLStats.getPlayerWho(1) != null){
		String uuid = de.gamelos.stats.SQLStats.getPlayerWhoUUID(1);
		...
		int wins = de.gamelos.stats.SQLStats.getWins(uuid, spieler1);
		int kills = de.gamelos.stats.SQLStats.getKills(uuid.toString(), spieler1);
		int tode = de.gamelos.stats.SQLStats.getTode(uuid.toString(), spieler1);
		double kd = 0.0;
		if(tode == 0){
			kd = kills;
		}else{
...
//		===========================================================================================================
		if(de.gamelos.stats.SQLStats.getPlayerWho(2) != null){
			String uuid = de.gamelos.stats.SQLStats.getPlayerWhoUUID(2);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins2 = de.gamelos.stats.SQLStats.getWins(uuid, spieler1);
		int kills2 = de.gamelos.stats.SQLStats.getKills(uuid, spieler1);
		int tode2 = de.gamelos.stats.SQLStats.getTode(uuid, spieler1);
		double kd2 = 0.0;
		if(tode2 == 0){
			kd2 = kills2;
		}else{
...
//		===========================================================================================================
		if(de.gamelos.stats.SQLStats.getPlayerWho(3) != null){
			String uuid = de.gamelos.stats.SQLStats.getPlayerWhoUUID(3);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins3 = de.gamelos.stats.SQLStats.getWins(uuid, spieler1);
		int kills3 = de.gamelos.stats.SQLStats.getKills(uuid, spieler1);
		int tode3 = de.gamelos.stats.SQLStats.getTode(uuid, spieler1);
		double kd3 = 0.0;
		if(tode3 == 0){
			kd3 = kills3;
		}else{
...
//		===========================================================================================================
		if(de.gamelos.stats.SQLStats.getPlayerWho(4) != null){
			String uuid = de.gamelos.stats.SQLStats.getPlayerWhoUUID(4);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = de.gamelos.stats.SQLStats.getWins(uuid, spieler1);
		int kills4 = de.gamelos.stats.SQLStats.getKills(uuid, spieler1);
		int tode4 = de.gamelos.stats.SQLStats.getTode(uuid, spieler1);
		double kd4 = 0.0;
		if(tode4 == 0){
			kd4 = kills4;
		}else{
...
//		===========================================================================================================
		if(de.gamelos.stats.SQLStats.getPlayerWho(5) != null){
			String uuid = de.gamelos.stats.SQLStats.getPlayerWhoUUID(5);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = de.gamelos.stats.SQLStats.getWins(uuid, spieler1);
		int kills4 = de.gamelos.stats.SQLStats.getKills(uuid, spieler1);
		int tode4 = de.gamelos.stats.SQLStats.getTode(uuid, spieler1);
...
//		===========================================================================================================
		if(de.gamelos.stats.SQLStats.getPlayerWho(6) != null){
			String uuid = de.gamelos.stats.SQLStats.getPlayerWhoUUID(6);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = de.gamelos.stats.SQLStats.getWins(uuid, spieler1);
		int kills4 = de.gamelos.stats.SQLStats.getKills(uuid, spieler1);
		int tode4 = de.gamelos.stats.SQLStats.getTode(uuid, spieler1);
...
//		===========================================================================================================
		if(de.gamelos.stats.SQLStats.getPlayerWho(7) != null){
			String uuid = de.gamelos.stats.SQLStats.getPlayerWhoUUID(7);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = de.gamelos.stats.SQLStats.getWins(uuid, spieler1);
		int kills4 = de.gamelos.stats.SQLStats.getKills(uuid, spieler1);
		int tode4 = de.gamelos.stats.SQLStats.getTode(uuid, spieler1);
...
//		===========================================================================================================
		if(de.gamelos.stats.SQLStats.getPlayerWho(8) != null){
			String uuid = de.gamelos.stats.SQLStats.getPlayerWhoUUID(8);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = de.gamelos.stats.SQLStats.getWins(uuid, spieler1);
		int kills4 = de.gamelos.stats.SQLStats.getKills(uuid, spieler1);
		int tode4 = de.gamelos.stats.SQLStats.getTode(uuid, spieler1);
...
//		===========================================================================================================
		if(de.gamelos.stats.SQLStats.getPlayerWho(9) != null){
			String uuid = de.gamelos.stats.SQLStats.getPlayerWhoUUID(9);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = de.gamelos.stats.SQLStats.getWins(uuid, spieler1);
		int kills4 = de.gamelos.stats.SQLStats.getKills(uuid, spieler1);
		int tode4 = de.gamelos.stats.SQLStats.getTode(uuid, spieler1);
...
//	===========================================================================================================
	if(de.gamelos.stats.SQLStats.getPlayerWho(10) != null){
		String uuid = de.gamelos.stats.SQLStats.getPlayerWhoUUID(10);
		String spieler1 = SpielerUUID.getSpielername(uuid);
	int wins4 = de.gamelos.stats.SQLStats.getWins(uuid, spieler1);
	int kills4 = de.gamelos.stats.SQLStats.getKills(uuid, spieler1);
	int tode4 = de.gamelos.stats.SQLStats.getTode(uuid, spieler1);
